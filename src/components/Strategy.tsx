...
const Strategy = () => {
    return (
        <div className="usecases js-scroll slide-right" id="strategy">
            <h1 className="text-[50px] usecases_title">Fund Utilization Strategy</h1>
            ...
            <div className="usecases_wrap">
                ...
                <div className="usecases_item">
                    <div className="p-10">
                        ...
                        <p className="usecases_dec">
                            Enter the battlefield with a strategic investment fo Crown Coins per Dragon Lord, fostering a financially participative and engaging environment.
                        </p>
                    </div>
                </div>
                <div className="usecases_item">
